...
$CloneServerUrl = "https://<https://nishithareddyp0542@dev.azure.com/nishithareddyp0542/Redgate/_git/Redgate>:14145"
$ImageName = "<image-name>"                 # SQL Clone image from which dev database clones will be created
$SqlServerMachineName = "<LAPTOP-3D8QMKVH\SQLSERVER>"    # SQL Server machine hosting the clone database (must have Clone Agent installed):
$SqlServerInstanceName = "<instance-name>"  # Use empty string for the default instance
$DBName = "Redgate_latest>"                    # Database name linked to project
